...
const NewsItem = ({ newsData }) => {
  ...
  const demoContent = {
    ...
    content: "Current Poland goalkeeper and former Arsenal star Wojciech Szczesny has revealed a surprising career change plan after he hangs up his gloves. The 34-year-old veteran shot-stopper is currently on to… [+2551 chars]"
  }
